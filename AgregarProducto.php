...
?>
    ...
    <head>
        ...
        <!-- Validacion js -->
        <script src="assets/js/validarpublicacion.js"></script>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      ...
      >
        <div class="offcanvas-body p-0">
          <nav class="navbar-dark">
            ...
            <li>
              <a href="ver.php" class="nav-link px-3">
            ...
            <li>
              <a href="PantallaAdmin.php" class="nav-link px-3">
    ...
    <div id="formulario_Pro">
            <div class="container p-5 my-5 border">
              ...
              <form action="procesaAgregar.php"  method="post" name="form1" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                  ...
                  <div class="col">
                    <input type="number" class="form-control" id="Pre" name="Pre" aria-label="Precio" placeholder="Precio $">
                  </div>
                </div>
                ...
                <div class="row g-3">
                  <div class="col">
                  <label for="lname" class="fontforusuario">Fotos</label>
                    <input type="file" name="imagenes[]" id="imagenes[]" class="form-control" placeholder="Fotos" multiple accept="image/*" > 
                  </div>
                </div>
                <br>
                ...
                <div class="row">
                  <div class="col-12">
                    ...
                    <center>
                        ...
                        <input id="btnIngresar" type="button" value="Ingresar" class="btn btn-success" onclick="ValidarAgregar();">
