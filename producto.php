								...
								<div class="welcome-hero-content">
									<div class="row">
										...
										<div class="col-sm-5">
											<div class="single-welcome-hero">
												<div class="welcome-hero-img">
													<img src="resource/images/Jardineras/model1.png" alt="slider image">
												</div><!--/.welcome-hero-txt-->
											</div><!--/.single-welcome-hero-->
										</div><!--/.col-->
									</div><!--/.row-->
								...
								<div class="welcome-hero-content">
									<div class="row">
										...
										<div class="col-sm-5">
											<div class="single-welcome-hero">
												<div class="welcome-hero-img">
													<img src="resource/images/Lapidas/model1.png" alt="slider image">
												</div><!--/.welcome-hero-txt-->
											</div><!--/.single-welcome-hero-->
										</div><!--/.col-->
									</div><!--/.row-->
				        ...
				        <div class="container">            
				            ...
				            <div class="attr-nav">
				                <ul>
				                	...
				                	<li class="nav-user">
				                		<a href="login.html"><span class="lnr lnr-user"></span></a>
				                	</li><!--/.search-->
				            ...
				            <div class="navbar-header">
				                ...
				                <a class="navbar-brand" href="index.html">Marmol<span>Jardines</span></a>
